...
# Комментарий:
# Корреляционное отношение (eta) равно 1, что указывает на полное соответствие между возрастной группировкой и частотой.
# Такое значение свидетельствует о сильной нелинейной связи, но результат в 1 может быть артефактом округления или группировки.
# Тем не менее, результат можно интерпретировать как наличие значимой нелинейной зависимости.
